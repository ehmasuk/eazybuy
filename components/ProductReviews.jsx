      ...
      <section className="bg-white py-8 antialiased md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <div className="my-6 gap-8 grid lg:grid-cols-12">
            <div className="shrink-0 space-y-4 lg:col-span-4">
              <div>
            ...
            <div className="lg:mt-12 mt-5 divide-gray-200 lg:col-span-8">
              {product?.reviews?.map((review, index) => {
                return (
                  <div key={index} className="gap-3 mb-6 pb-3 border-b sm:flex sm:items-start">
                      ...
                      {review.images?.length > 0 && (
                        <div className="flex gap-2">
                          {review.images.map((url, index) => {
                            return <Image key={index} className="!w-20 rounded !object-contain" src={url} alt="imac-photo-2" />;
                          })}
                        </div>
                      )}
                    </div>
