...
import { Button, Form, Image, message, Popconfirm, Select, Table, Upload } from 'antd';
...
function SubCategories() {
  ...
  const { data: allSubCategories, isLoading } = useSWR('/subcategories');
                ...
                <div className="w-[975px] 2xl:w-full">
                  <section className="container px-4 mx-auto">
                    ...
                    <div className="flex flex-col mt-6">
                      <Table dataSource={allSubCategories} columns={columns} loading={isLoading} />
                    </div>
                  </section>
                </div>
              </div>
